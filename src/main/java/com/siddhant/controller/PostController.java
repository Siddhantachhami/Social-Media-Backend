...
import com.siddhant.response.ApiResponse;
import com.siddhant.service.PostService;
...
public class PostController {
	...
	public ResponseEntity<Post> creatPost(@RequestHeader("Authorization")String jwt,@RequestBody Post post) throws Exception{
